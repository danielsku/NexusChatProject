...
CREATE TABLE `sent_to` (
  ...
  CONSTRAINT `sent_to_ibfk_1` FOREIGN KEY (`message_id`) REFERENCES `message` (`message_id`),
  CONSTRAINT `sent_to_ibfk_2` FOREIGN KEY (`receiver_id`) REFERENCES `message_delivery` (`receiver_id`)
...
INSERT INTO `sent_to` VALUES ('545cea2a-3816-4dbb-b6fb-57951eb19e0e','e7258dc9-0398-46b1-80d5-2fafe5a53bca');
