...
1. Open the application on the GitHub repository and download it  
...
_If there are issues with the GUI while running "NexusReworked.exe" (such as the example below), repeat steps 1-5 with the "exe2" file instead_
<details>
