...
public class MyStompClient {
    ...
    public MyStompClient(MessageListener messageListener, String username, GroupChatService groupChatService, IdentityService identityService) throws ExecutionException, InterruptedException {
        ...
        this.sessionHandler = new MyStompSessionHandler(messageListener, username, groupChatService, identityService);
